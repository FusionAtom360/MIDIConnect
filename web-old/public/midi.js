document.addEventListener("DOMContentLoaded", () => {
    ...
    function inputDeviceChangeHandler(event) {
        ...
        console.log(
            `Input Device selected: ${selectedInputDevice ? selectedInputDevice.name : "None"
            }`
        );
    ...
    function outputDeviceChangeHandler(event) {
        ...
        console.log(
            `Output Device selected: ${selectedOutputDevice ? selectedOutputDevice.name : "None"
            }`
        );
    }
